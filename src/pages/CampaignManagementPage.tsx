...
export function CampaignManagementPage({ onNavigate }: CampaignManagementPageProps) {
  ...
  const [formData, setFormData] = useState({
    name: '',
    notification_type: 'promotional_offers' as 'promotional_offers' | 'order_updates' | 'newsletters',
    city_filter: '',
    content: '',
  });
      ...
      <div className="px-4">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">Create and manage your notification campaigns</p>
          </div>
          {!isViewer() && (
            <button
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div className="space-y-2 text-sm text-gray-600">
                      ...
                      {campaign.city_filter && (
                        <p>
                          <span className="font-medium">City Filter:</span> {campaign.city_filter}
                        </p>
                      )}
                      <p>
                        <span className="font-medium">Content:</span> {campaign.content}
                      </p>
                      <p>
                  ...
                  <div className="flex space-x-2">
                    <button
                      onClick={() => onNavigate('campaign-preview', { campaignId: campaign.id })}
                    ...
                    {campaign.status === 'draft' && !isViewer() && (
                      <button
                        onClick={() =>
                          onNavigate('campaign-send', { campaignId: campaign.id })
                        }
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        notification_type: e.target.value as typeof formData.notification_type,
                      })
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                    required
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, city_filter: e.target.value })}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
